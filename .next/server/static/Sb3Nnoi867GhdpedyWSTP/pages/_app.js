...
var external_next_redux_wrapper_ = __webpack_require__(17);
var external_next_redux_wrapper_default = /*#__PURE__*/__webpack_require__.n(external_next_redux_wrapper_);

// EXTERNAL MODULE: external "redux"
var external_redux_ = __webpack_require__(14);

// CONCATENATED MODULE: ./src/reducers/session.js
...
/* harmony default export */ var session = (sessionReducer);
// CONCATENATED MODULE: ./src/reducers/user.js
function user_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { user_defineProperty(target, key, source[key]); }); } return target; }
...
function userReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : user_INITIAL_STATE;
  var action = arguments.length > 1 ? arguments[1] : undefined;
...
/* harmony default export */ var src_store = (store_initStore);
...
var _app_EnhancedApp =
/*#__PURE__*/
function (_App) {
  _inherits(EnhancedApp, _App);

  function EnhancedApp() {
    _classCallCheck(this, EnhancedApp);

    return _possibleConstructorReturn(this, _getPrototypeOf(EnhancedApp).apply(this, arguments));
  }

  _createClass(EnhancedApp, [{
    key: "render",
...
/* harmony default export */ var _app = __webpack_exports__["default"] = (external_next_redux_wrapper_default()(src_store)(_app_EnhancedApp));
