...
// EXTERNAL MODULE: ./pages/pw-forget.js
var pw_forget = __webpack_require__(12);

// EXTERNAL MODULE: ./src/components/App/index.js + 4 modules
var App = __webpack_require__(7);

// EXTERNAL MODULE: ./src/firebase/index.js + 3 modules
var firebase = __webpack_require__(2);

// CONCATENATED MODULE: ./src/components/PasswordChange/index.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var PasswordChange_PasswordChangeForm =
/*#__PURE__*/
function (_Component) {
  ...
  function PasswordChangeForm(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(PasswordChangeForm).call(this, props));

    _defineProperty(_assertThisInitialized(_this), "onSubmit", function (event) {
      var passwordOne = _this.state.passwordOne;
      firebase["a" /* auth */].doPasswordUpdate(passwordOne).then(function () {
        _this.setState(function () {
          return _objectSpread({}, INITIAL_STATE);
        });
      }).catch(function (error) {
  ...
  _createClass(PasswordChangeForm, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("form", {
        ...
        disabled: isInvalid,
        type: "submit"
      }, "Reset My Password"), error && external_react_default.a.createElement("p", null, error.message));
    }
  }]);
...
/* harmony default export */ var PasswordChange = (PasswordChange_PasswordChangeForm);
...
var account_AccountPage = function AccountPage(_ref) {
  var authUser = _ref.authUser;
  return external_react_default.a.createElement(App["b" /* AppWithAuthorization */], null, external_react_default.a.createElement("h1", null, "Account: ", authUser.email), external_react_default.a.createElement(pw_forget["PasswordForgetForm"], null), external_react_default.a.createElement(PasswordChange, null));
};
...
/* harmony default export */ var account = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps)(account_AccountPage));
